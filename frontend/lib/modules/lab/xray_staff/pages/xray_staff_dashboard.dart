...
class XrayStaffDashboard extends StatefulWidget {
  const XrayStaffDashboard({super.key});

  @override
  State<XrayStaffDashboard> createState() => _XrayStaffDashboardState();
}

class _XrayStaffDashboardState extends State<XrayStaffDashboard> {
