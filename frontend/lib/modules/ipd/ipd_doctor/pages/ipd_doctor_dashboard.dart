...
class IpdDoctorDashboard extends StatefulWidget {
  const IpdDoctorDashboard({super.key});

  @override
  State<IpdDoctorDashboard> createState() => _IpdDoctorDashboardState();
}

class _IpdDoctorDashboardState extends State<IpdDoctorDashboard> {
