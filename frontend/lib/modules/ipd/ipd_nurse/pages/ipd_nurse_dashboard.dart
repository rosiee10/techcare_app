...
class IpdNurseDashboard extends StatefulWidget {
  const IpdNurseDashboard({super.key});

  @override
  State<IpdNurseDashboard> createState() => _IpdNurseDashboardState();
}

class _IpdNurseDashboardState extends State<IpdNurseDashboard> {
  ...
  Widget _buildContent() {
    ...
    switch (_selectedIndex) {
      ...
      case 1:
        return _buildPatientMonitoring();
      case 2:
  ...
  Widget _buildPatientMonitoring() {
    return const Center(child: Text('Patient Monitoring - Coming Soon'));
  }

  Widget _buildInventory() {
    return const IpdNurseInventoryPage();
  }

  Widget _buildRequest() {
    return const IpdNurseRequestPage();
  }
