...
/// Profile header with time-based greeting and morning/evening images
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<AuthProvider>(
      builder: (context, authProvider, _) {
        final firstName = authProvider.fullName?.split(' ').first ?? 'User';
                ...
                Container(
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      // Fallback: show colored container with icon
