...
class OpdNurseDashboard extends StatefulWidget {
  const OpdNurseDashboard({super.key});

  @override
  State<OpdNurseDashboard> createState() => _OpdNurseDashboardState();
}

class _OpdNurseDashboardState extends State<OpdNurseDashboard> {
