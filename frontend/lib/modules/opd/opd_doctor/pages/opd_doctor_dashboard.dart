...
class OpdDoctorDashboard extends StatefulWidget {
  const OpdDoctorDashboard({super.key});

  @override
  State<OpdDoctorDashboard> createState() => _OpdDoctorDashboardState();
}

class _OpdDoctorDashboardState extends State<OpdDoctorDashboard> {
