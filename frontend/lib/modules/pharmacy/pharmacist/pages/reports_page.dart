...
class _ReportsPageState extends State<ReportsPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildReportConfigCard(isMobile),
          const SizedBox(height: 32),
          _buildAvailableReportsSection(isMobile),
        ],
      ),
    );
  }
  ...
  Widget _buildReportConfigCard(bool isMobile) {
  ...
  Widget _buildAvailableReportsSection(bool isMobile) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.min,
      children: [
        ...
        const SizedBox(height: 16),
        isMobile ? _buildMobileReportCards() : _buildDesktopReportCards(),
      ],
    );
  }
