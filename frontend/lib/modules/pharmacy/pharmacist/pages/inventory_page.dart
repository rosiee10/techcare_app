                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        label: Text(isMobile ? 'Add' : 'Add Medicine'),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _buildStatCard(
                          title: isMobile ? 'Expiring' : 'Expiring Soon',
            ...
            child: Column(
              ...
              children: [
                ...
                if (_isLoading)
                  ...
                  (isMobile || isTablet)
                    ? // Mobile & Tablet: Card-based Medicine List
                      Column(
                        children: [
                          ...
                          ..._filteredMedicines.asMap().entries.map((entry) {
                            ...
                            return Column(
                              children: [
                                ...
                                if (entry.key < _filteredMedicines.length - 1)
