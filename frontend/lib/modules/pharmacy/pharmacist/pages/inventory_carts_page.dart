            ...
            ? Column(
                children: [
                  Row(
                    children: [
                      _buildStatCard(
                        title: isMobile ? 'Total' : 'Total Medicines',
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      _buildStatCard(
                        title: isMobile ? 'Dispensed' : 'Today Dispensed',
                        value: _isLoading ? '-' : '0',
            ...
            child: Column(
              ...
              children: [
                ...
                if (_isLoading)
                  ...
                  Column(
                    children: _filteredCartItems.asMap().entries.map((entry) {
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Batches', style: TextStyle(fontSize: 11, color: Colors.grey[500])),
                      const SizedBox(height: 2),
                      Text(
                        '$batchCount',
                        style: const TextStyle(
                  ...
                  children: [
                    IconButton(
                      onPressed: () async {
                        ...
                        await RestockCartDialog.show(context, medicine: medicineData);
                        await _loadCart(showLoading: false);
                      },
                      icon: const Icon(Icons.shopping_cart_outlined, size: 20, color: Color(0xFF2196F3)),
