            ...
            ? Column(
                children: [
                  Row(
                    children: [
                      _buildStatCard(
                        title: isMobile ? 'High' : 'High Demand',
                      ...
                      _buildStatCard(
                        title: isMobile ? 'Med' : 'Medium Demand',
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      _buildStatCard(
                        title: isMobile ? 'Critical' : 'Critical Stock',
        ...
        (isMobile || isTablet)
          ...
          : Row(
              children: [
                ...
                const SizedBox(width: 16),
                Expanded(child: _buildTrendsCard()),
              ],
            ),
        const SizedBox(height: 24),
              ...
              children: [
                Row(
                  children: [
                    ...
                    const SizedBox(width: 12),
                    _buildStockCard(
                      title: isMobile ? 'Low' : 'Low Stock Items',
                ...
                Row(
                  children: [
                    _buildStockCard(
                      title: isMobile ? 'Adequate' : 'Adequate Stock',
                    ...
                    const SizedBox(width: 12),
                    _buildStockCard(
                      title: isMobile ? 'Moderate' : 'Moderate Stock',
